...
export default function Register() {
    ...
    <div className='w-full min-h-screen flex justify-center items-center bg-gray-900'>
        <div className='relative w-[450px] h-[600px] bg-gray-800 rounded-lg overflow-hidden'>
            ...
            <div className='absolute inset-1 bg-gray-800 rounded-lg z-10 p-5'>
                <form onSubmit={handleSubmit}>
                    <h2 className='text-xl font-semibold text-lime-500 text-center mb-12 mt-6'>Register</h2>
