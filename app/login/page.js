...
export default function Login() {
    ...
    <div className='w-full min-h-screen flex justify-center items-center bg-gray-800'>
        <div className='relative w-[380px] h-[420px] bg-gray-700 rounded-lg overflow-hidden'>
            ...
            <div className='absolute inset-1 bg-gray-700 rounded-lg z-10 p-5'>
                <form onSubmit={handleSubmit}>
                    <h2 className='text-xl font-semibold text-teal-400 text-center mb-12 mt-6'>Sign in</h2>
